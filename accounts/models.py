...
class Account(models.Model):
  ...
  profile_pic = models.ImageField(default="card.svg")
  ...
  def isPatient(self):
    qs = Patient.objects.filter(patientUser=self)
    if qs.exists():
      return True 
    return False
...
class Patient(models.Model):
  ...
  Note = models.TextField(verbose_name=u"Ghi chú", null=True, blank=True)
